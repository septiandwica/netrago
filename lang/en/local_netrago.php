...
$string['requireaudio'] = 'Require Audio/Microphone Monitoring';
$string['requireaudio_help'] = 'If enabled, students must provide access to their microphone. Ambient noise and conversations will be monitored to detect cheating.';
